...
cache_obj_bbox_format='/vision/group/prolix/processed/all/obj_bbox_20fps_merged/{}_seg{}.pkl'

load_cache='feats'
cache_format_base='/vision/group/prolix/processed/cache/all/STIP_conv_feats/'
